...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            C3Ghost, nn.Conv2d, nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3, PSA, SCDown, C2fCIB, LFAU, C2f_ODConv,
            LFAU_EMA, C2f_DBB, GSConv, GSConvns, VoVGSCSP, VoVGSCSPns, VoVGSCSPC, C2f_CloAtt, C3_CloAtt, SCConv, C2f_SCConv, C3_SCConv, C2f_ScConv, C3_ScConv,
            C3_EMSC, C3_EMSCP, C2f_EMSC, C2f_EMSCP, RCSOSA, KWConv, C2f_KW, C3_KW, DySnakeConv, C2f_DySnakeConv, C3_DySnakeConv,
            DCNv2, C3_DCNv2, C2f_DCNv2, DCNV3_YOLO, C3_DCNv3, C2f_DCNv3, LFAU_C3, LFAU_C3_EMA, C3_ODConv,
            ...
            LFAU_C3_CGLU, LFAU_CGLU, C3_Star, C2f_Star, C3_Star_CAA, C2f_Star_CAA, C3_KAN, C2f_KAN, C3_EIEM, C2f_EIEM, C3_DEConv, C2f_DEConv,
            ...
            C2f_FMB, LDConv, C2f_gConv, C2f_WDBB, C2f_DeepDBB, C2f_AdditiveBlock, C2f_AdditiveBlock_CGLU, CSP_MSCB
        }:
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in {
                     BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB, LFAU, C2f_ODConv, LFAU_EMA, C2f_DBB,
                     ...
                     C3_DCNv2, C2f_DCNv2, C3_DCNv3, C2f_DCNv3, LFAU_C3, LFAU_C3_EMA, C3_ODConv, C3_OREPA, C2f_OREPA, C3_DBB,
                     ...
                     C3_FADC, C2f_FADC, C3_PPA, C2f_PPA, RGCSPELAN, LFAU_C3_CGLU, LFAU_CGLU, C3_Star, C2f_Star, C3_Star_CAA, C2f_Star_CAA,
            ...
            c2 = m.channel
                   ...
                   SEAttention, CPCA, PConv3, FocalModulation, EfficientAttention, MPCA, deformable_LKA,
